...
int main() {
    ...
    SetProperty("vendor.qti.nfc.chipid", fmt::format("0x{:02x}", info.info.chip_type));
    SetProperty("vendor.qti.nfc.fwver", fmt::format("{:02x}.{:02x}.{:02x}",
            info.info.rom_version, info.info.fw_major, info.info.fw_minor));
