...
int main() {
    ...
    chipid << "0x" << std::setfill('0') << std::setw(2) << std::right << std::hex << info.info.chip_type;
    SetProperty("vendor.qti.nfc.chipid", chipid.str());
    std::stringstream fwver;
    fwver << std::setfill('0') << std::setw(2) << std::right << std::hex << info.info.rom_version;
    fwver << "." << std::setfill('0') << std::setw(2) << std::right << std::hex << info.info.fw_major;
    fwver << "." << std::setfill('0') << std::setw(2) << std::right << std::hex << info.info.fw_minor;
